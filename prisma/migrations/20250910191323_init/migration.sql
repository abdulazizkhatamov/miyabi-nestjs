...
-- AddForeignKey
ALTER TABLE "public"."Order" ADD CONSTRAINT "Order_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
